...
function Footer() {
  return (
    <footer className="bg-gray-200  antialiased">
        ...
        <div className="border-b border-gray-100 py-6 md:py-8 lg:py-16">
          <div className="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
            ...
            <div className="mt-6 w-full md:mt-8 lg:mt-0 lg:max-w-lg">
              <div className="space-y-5 rounded-lg bg-gray-200 p-6 ">
                <a
                  href="#"
                  title=""
                  className="text-base  font-medium text-primary-700 text-blue-400 underline hover:no-underline "
                >
                  {" "}
                ...
                <form action="#">
                  <div className="items-end space-y-4 sm:flex sm:space-y-0">
                    <div className="relative mr-3 w-full sm:w-96 lg:w-full">
                      ...
                      <input
                        className="block w-full rounded-lg border border-gray-300 bg-white p-3 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500  sm:w-96 lg:w-full"
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-full cursor-pointer rounded-lg bg-primary-700 bg-gray-500 px-5 py-3 text-center text-sm font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 "
                      >
                        Subscribe
                      </button>
                    </div>
        ...
        <div className="py-6 md:py-8">
          <div className="gap-4 space-y-5 xl:flex xl:items-center xl:justify-between xl:space-y-0">
            ...
            <p className="text-sm text-gray-500 ">
              Al Thakeel © 2025, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </div>
